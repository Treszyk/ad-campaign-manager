...
public class DataSeeder implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    List<EmeraldAccountJpaEntity> aliceAccounts =
        List.of(
    ...
    List<EmeraldAccountJpaEntity> savedAliceAccounts =
        emeraldAccountJpaRepository.saveAll(aliceAccounts);

    List<EmeraldAccountJpaEntity> bobAccounts =
        List.of(
            new EmeraldAccountJpaEntity(
    ...
    List<EmeraldAccountJpaEntity> savedBobAccounts =
        emeraldAccountJpaRepository.saveAll(bobAccounts);

    List<ProductJpaEntity> aliceProducts =
        List.of(
    ...
    List<ProductJpaEntity> bobProducts =
        List.of(
            new ProductJpaEntity(
    ...
    CampaignJpaEntity aliceCampaign =
